...
/* Kanban access control: managers see the full board; members see no Kanban page/icon. */
(function(){
'use strict';
...
const obs=new MutationObserver(()=>{const nav=document.getElementById('nav_board');if(nav&&!isManager())nav.setAttribute('data-tf-hidden','1');applyAccess()});
